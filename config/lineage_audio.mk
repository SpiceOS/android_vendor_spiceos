...
ALARM_PATH := vendor/spiceos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/spiceos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/spiceos/prebuilt/common/media/audio/ringtones
